...
/**
 * Создает платежный счет в ЮKassa с использованием Telegram Payments API
 * как описано в документации: https://yookassa.ru/docs/support/payments/onboarding/integration/cms-module/telegram
 * 
